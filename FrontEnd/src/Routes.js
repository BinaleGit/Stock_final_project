...
import About from './screens/About'; // Import About component
  ...
  return (
    <>
      ...
      <div className={loading ? "blur-sm pointer-events-none" : ""}>
        <Routes>
          <Route path="/" element={<StockGraph setLoading={setLoading} />} />
          <Route path="/stock-info" element={<StockInfo data={stockData} />} />
